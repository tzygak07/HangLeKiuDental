<style>
    ...
    .apt-search-box input { border: none; outline: none; font-size: 13px; color: #582C0C; background: transparent; width: 160px; }
    ...
    .apt-btn-outline { background: #fff; color: #582C0C; border: 1px solid #E5D6C5; padding: 8px; border-radius: 5px; font-size: 13px; cursor: pointer; display: inline-flex; align-items: center; transition: all .2s; }
